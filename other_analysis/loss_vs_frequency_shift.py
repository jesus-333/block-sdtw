...
ax.set_xlabel("Frequency shift [Hz]", fontsize = plot_config['fontsize'])
...
ax.grid(True)
ax.set_title("f1 = {}Hz, A1 = {}, A2 = {}".format(f_1, amplitude_1, amplitude_2), fontsize = plot_config['fontsize'])
