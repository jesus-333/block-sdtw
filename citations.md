...
You can find the original repo here https://github.com/Maghoumi/pytorch-softdtw-cuda
```
...
SDTW implementation by Antoine Loriette. Also available on PyPi.

To the best of our knowledge no paper or any other work was mentioned in the GitHub page and PyPi page of this SDTW implementation.
- GitHub repo : https://github.com/toinsson/pysdtw
- PyPi Page : https://pypi.org/project/pysdtw/

### `ron` 
Very efficient and modern implementation of SoftDTW by Ron Shapira Weber.
You can find the original repo at https://github.com/BGU-CS-VIL/sdtw-cuda-torch

```
@misc{weber2026softdtwcudatorchmemoryefficientgpuacceleratedsoft,
...
@InProceedings{pmlr-v267-shapira-weber25a,
