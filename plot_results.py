...
def plot_prediction(ts_index, X_test, 
                    y_pred_MSE, y_pred_SDTW, y_pred_block_SDTW, 
    ...
    ax.set_title('Prediction of the time series ' + str(ts_index), fontsize = plot_config['fontsize'])
...
if plot_and_save_all:
    ...
    for i in range(len(X_test)):
        ...
        fig, ax = plot_prediction(i, X_test, y_pred_MSE, y_pred_SDTW, y_pred_block_SDTW, plot_config, show_figure = False)
